...
Namespace Dashboard_CreateChart
    ...
    Public Partial Class Form1
        ...
        Private Function CreateChart(ByVal dataSource As DataSource) As ChartDashboardItem
            ...
            chart.Panes.Add(New ChartPane())
            Dim taxesAmountSeries As SimpleSeries = New SimpleSeries(SimpleSeriesType.StackedBar)
